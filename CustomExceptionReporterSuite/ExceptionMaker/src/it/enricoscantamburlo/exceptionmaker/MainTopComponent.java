 ...
 */
package it.enricoscantamburlo.exceptionmaker;
 ...
 */
@ConvertAsProperties(
        dtd = "-//it.enricoscantamburlo.exceptionmaker//Main//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "it.enricoscantamburlo.exceptionmaker.MainTopComponent")
