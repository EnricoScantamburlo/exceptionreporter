 ...
 */
package it.enricoscantamburlo.exceptionreporter;
...
public final class MyErrorManager extends Handler {

    public MyErrorManager() {
    ...
    /**
     * If recursively is true it is not adviced to print all annotations because
     * a lot of warnings will be printed. But while searching for localized
     * message we should scan all the annotations (even recursively).
     */
    ...
    /**
     * Another final class that is used to communicate with NotifyExcPanel and
     * provides enough information to the dialog.
     */
    static final class Exc {
        ...
        /**
         * @param severity if -1 then we will compute the severity from
         * annotations
         */
        ...
        String getLocalizedMessage() {
            ...
            for (int i = 0; i < arrAll.length; i++) {
                String s = MyErrorManager.getLocalizedMessage(arrAll[i]);
                if (s != null) {
                    return s;
                }
            }
        ...
        /**
         * Prints stack trace of all annotations and if there is no annotation
         * trace then of the exception
         */
 ...
 /*Annotations */
            for (LogRecord rec : arr) {
                ...
                String annotation = MyErrorManager.getLocalizedMessage(rec);
        ...
        /**
         * Method that iterates over annotations to find out the first
         * annotation that brings the requested value.
         *
            ...
            for (int i = 0; i < arr.length; i++) {
                ...
                switch (kind) {
                    case 1: // message
                        ...
                        break;
                    case 2: // localized
                        o = MyErrorManager.getLocalizedMessage(a);
                        break;
                    case 3: // class name
                    {
